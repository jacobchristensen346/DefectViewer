...
def defect_density(image_origin, db_origin, scan_id, analysis_id, tile_size, image_size):
    ...
    canvas.bind('<Button-1>', lambda event, arg = position_data, arg1 = defect_data: clicked(event, arg, arg1))
    #canvas.bind('<Button-1>', clicked(next(os.walk('C:/Users/Jacob/Downloads/images/'))[2]))
